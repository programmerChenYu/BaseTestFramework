...
public class WebBaseHandler {
    ...
    public void switchToIframe(WebElement element) {
        this.webBasePage.getDriver().switchTo().frame(element);
    ...
    public void switchToDefaultContent() {
        this.webBasePage.getDriver().switchTo().defaultContent();
        log.info("切换回顶层页面");
    }
    ...
    public Object executeJavaScript(String script, Object... args) {
        JavascriptExecutor jsExecutor = (JavascriptExecutor) this.webBasePage.getDriver();
    ...
    public void switchToWindow(String handle) {
        this.webBasePage.getDriver().switchTo().window(handle);
    ...
    public void switchToLastWindow() {
        Set<String> handlesSet = this.webBasePage.getDriver().getWindowHandles();
        List<String> handles = handlesSet.stream().toList();
        this.webBasePage.getDriver().switchTo().window(handles.get(handles.size()-1));
    ...
    public String getCurrentWindowHandle() {
        String handle = this.webBasePage.getDriver().getWindowHandle();
    ...
    public void closeCurrentWindowAndSwitchBack() {
        String handle = this.webBasePage.getDriver().getWindowHandle();
        this.webBasePage.getDriver().close();
        log.info("关闭当前窗口");
        this.webBasePage.getDriver().switchTo().window(handle);
    ...
    public void hoverOverElement(WebElement element) {
        Actions actions = new Actions(this.webBasePage.getDriver());
    ...
    public void takeScreenshot(String clasName) {
        ...
        File screenshot = ((TakesScreenshot) this.webBasePage.getDriver()).getScreenshotAs(OutputType.FILE);
